...
mod tests {
    ...
    fn should_search_field_prefix() {
        ...
        assert!(should_search("from:alice"));
    }
    ...
    fn load_save_roundtrip() {
        ...
        let folders = vec![
            SmartFolder {
                ...
                query: "from:alice flag:unread".into(),
            },
            SmartFolder {
        ...
        assert_eq!(parsed.folders[0].name, "Unread from Alice");
        assert_eq!(parsed.folders[0].query, "from:alice flag:unread");
